#pragma checksum "F:\参与的项目\Working\Working\Views\User\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e4be8d9eb5bce39a9acdb648fa57ec6596577417"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e4be8d9eb5bce39a9acdb648fa57ec6596577417", @"/Views/User/Index.cshtml")]
    ...
    public class Views_User_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "F:\参与的项目\Working\Working\Views\User\Index.cshtml"
   ViewData["Title"] = "用户管理"; 
...
#nullable disable
    ...
    <div class=""panel panel-default"" style=""margin-bottom:-10px;"">
            ...
            <div class=""row"">
                <div class=""col-md-3"">
                    <select id=""departmentselect"" class=""form-control"" v-cloak v-model=""selected"" v-on:change=""ChangeDepartment"">
                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e4be8d9eb5bce39a9acdb648fa57ec65965774174519", async() => {
     ...
     ");
            WriteLiteral(@"                   <tbody id=""usertr""></tbody>
                    </table>
                </div>
            </div>
...
<div class=""modal fade"" id=""ModiyModal"" tabindex=""-1"" role=""dialog"" aria-labelledby=""myModalLabel"" aria-hidden=""true"">
    <div class=""modal-dialog"">
        <div class=""modal-content"" id=""edituser"">
            ...
            WriteLiteral(@"l"" v-model=""user.username"" placeholder=""用户名"">
                    </div>
                </div>
                <div class=""row"" style=""margin-top:10px;"">
                    <div class=""col-md-6"">
                        <select id=""roleselect"" class=""form-control"" v-cloak>
                            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e4be8d9eb5bce39a9acdb648fa57ec65965774178177", async() => {
...
<div class=""modal fade"" id=""AddModal"" tabindex=""-1"" role=""dialog"" aria-labelledby=""myModalLabel"" aria-hidden=""true"">
    <div class=""modal-dialog"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                <div class=""row"" s");
            WriteLiteral(@"tyle=""margin-top:10px;"">
                    <div class=""col-md-6"">
                    ...
                    <div class=""col-md-6"">
                        <select id=""addroleselect"" class=""form-control"" v-cloak>
                            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e4be8d9eb5bce39a9acdb648fa57ec659657741710794", async() => {
                WriteLiteral("{{item.rolename}}");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
    ...
    <script>function SavaAdd() {
            $.ajax({
                ...
                success: function (backData) {
                    if (backData.result == 1) {
                     ");
                WriteLiteral(@"   $(""#ModiyModal"").modal('hide');
        ...
        function LoadDepartment() {
            $.ajax({
                method: ""GET"",
                url: '/Depar");
                WriteLiteral(@"tments/getalldepartment',
                data: {
                },
                success: function (backData) {
                    if (backData.result == 1) {
                        if (departmentVue == null) {
                            ...
                            $(""#adddepartm");
                WriteLiteral(@"entname"").val($(""#departmentselect"").find(""option:selected"").text());
                        }
                        else {
            ...
            if (editVue == null) {
                editVue = new Vue({
                    ...
                    methods: {
                        savaUser: function () {
  ");
                WriteLiteral(@"                          this.user.roleid = $(""#roleselect"").val();
                            $.ajax({
                                method: ""PUT"",
                                url: '/User/modifyuser',
                                data: {
                    ...
                    watch: {
                        r");
                WriteLiteral(@"oleid: function (newroleid) {
